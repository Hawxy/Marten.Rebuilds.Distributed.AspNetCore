...
{
    private readonly HashSet<string> _rebuildBlockedMethods =
        [HttpMethod.Post.Method, HttpMethod.Delete.Method, HttpMethod.Patch.Method, HttpMethod.Put.Method];

    private const string RebuildRoute = "/rebuild";
